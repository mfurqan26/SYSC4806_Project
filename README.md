...
Bookstore Owner can upload and edit com.amazin.Book information (com.amazin.ISBN, picture, description, author, publisher,...) and inventory. 
...
User can also view com.amazin.Book Recommendations based on past purchases. 
