...
Bookstore Owner can upload and edit amazin.Book information (ISBN, picture, description, author, publisher,...) and inventory. 
...
User can also view amazin.Book Recommendations based on past purchases. 
