...
Bookstore Owner can upload and edit example.Book information (example.ISBN, picture, description, author, publisher,...) and inventory. 
...
User can also view example.Book Recommendations based on past purchases. 
